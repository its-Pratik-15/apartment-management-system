    ...
    switch (userRole) {
      case 'SECRETARY':
        return [
          ...
          { name: 'Leases', href: '/dashboard/leases', icon: 'document' },
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 flex z-40 md:hidden">
          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
            ...
            <SidebarContent navigationItems={navigationItems} getIcon={getIcon} />
          </div>
        </div>
      )}
...
const SidebarContent = ({ navigationItems, getIcon }) => (
  <div className="flex flex-col h-0 flex-1 border-r border-gray-200 bg-white">
    <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
      <div className="flex items-center flex-shrink-0 px-4">
        ...
        <span className="ml-2 text-lg font-semibold text-gray-900">AMS</span>
      </div>
